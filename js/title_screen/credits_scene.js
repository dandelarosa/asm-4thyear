function CreditsScene() {
  ...
  this.draw = function() {
    ...
    drawText('Annual Saga Monthly Game 4 (July 2018)', GAME_WIDTH/2, 150, 'black', 'center', 'middle');
    drawText('Dexternites 1 Prototype', GAME_WIDTH/2, 200, 'black', 'center', 'middle');
